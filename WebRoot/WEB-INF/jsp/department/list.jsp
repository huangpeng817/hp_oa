...
<div id="MainArea">
    <table class="TableStyle" cellpadding="0" cellspacing="0">
        ...
        <tbody id="TableData" class="dataContainer" datakey="departmentList">
        	...
        	<tr class="TableDetail1 demodata_record">
				...
				<td><a onclick="return window.confirm('这将删除所有的下级部门，您确定要删除吗？')" href="<c:url value='/DepartmentServlet?method=delete&id=${department.id }&parentId=${parent.parent.id }'/>">删除</a>
    ...
    <div id="TableTail">
        <div id="TableTail_inside">
            <a href="<c:url value='/DepartmentServlet?method=addUI'/>"><img src="${pageContext.request.contextPath }/style/images/createNew.png"></a>
